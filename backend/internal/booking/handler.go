...
func (h *Handler) ReserveHandler(c *gin.Context) {
	...
	res, err := h.service.ReserveSeats(c.Request.Context(), userID, req)
	if err != nil {
...
func (h *Handler) CancelHandler(c *gin.Context) {
	...
	err := h.service.CancelReservation(c.Request.Context(), userID, req)
	if err != nil {
...
func (h *Handler) ConfirmHandler(c *gin.Context) {
	...
	err := h.service.ConfirmReservation(c.Request.Context(), userID, req)
	if err != nil {
		c.JSON(http.StatusConflict, gin.H{"error": err.Error()})
		return
	}
